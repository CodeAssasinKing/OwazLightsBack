...
def files_list_view(request):
    ...
    queryset = ProductDocumentations.objects.filter(is_active=True).order_by("-created_at")
    ...
    serializer = ProductDocumentationsSerializer(queryset, many=True, context={'request': request})
